...
lifestyle_label = tk.Label(root, text="Lifestyle (Ex: Poor, Modest, Comfortable, Wealthy):")
lifestyle_label.pack()
lifestyle_entry = tk.Entry(root)
lifestyle_entry.pack()

race_label = tk.Label(root, text="Race (Ex: Human, Elf, Dwarf, Halfling):")
race_label.pack()
race_entry = tk.Entry(root)
race_entry.pack()

class_label = tk.Label(root, text="Class (Ex: Barbarian, Rogue, Bard, Sorcerer):")
class_label.pack()
class_entry = tk.Entry(root)
class_entry.pack()

personality_label = tk.Label(root, text="Personality (Ex: Cowardly, Friendly, Greedy, Hasty):")
personality_label.pack()
personality_entry = tk.Entry(root)
personality_entry.pack()

background_label = tk.Label(root, text="Background (Ex: Acolyte, Charlatan, Criminal, Entertainer):")
background_label.pack()
background_entry = tk.Entry(root)
background_entry.pack()

gender_label = tk.Label(root, text="Gender (Ex: Male, Female, Nonbinary):")
gender_label.pack()
gender_entry = tk.Entry(root)
gender_entry.pack()

location_label = tk.Label(root, text="Location (Ex: Forest Village, Mountain Village, Mountain City):")
location_label.pack()
